...
class GuidedMed extends StatefulWidget {
  @override
  _GuidedMedState createState() => _GuidedMedState();
}

class _GuidedMedState extends State<GuidedMed> {
      ...
      appBar: AppBar(
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text('Guided Meditation',style: TextStyle(
